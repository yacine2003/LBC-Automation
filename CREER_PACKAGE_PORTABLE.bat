...
echo ========================================
echo.
echo Package complet avec Python portable
echo Duree : 10-15 minutes - Taille : ~500 MB
echo.
pause
echo.
...
echo.
echo [2/8] Telechargement de Python Portable...
...
echo.
echo [6/8] Installation de Chromium...
...
echo ========================================
echo.
echo Package : LBC_Portable\ (~500 MB)
echo.
echo PROCHAINES ETAPES :
echo 1. Copier service_account.json dans LBC_Portable\
echo 2. Tester avec DEMARRER.bat
echo 3. Creer un ZIP
echo 4. Envoyer au client
echo.
pause
